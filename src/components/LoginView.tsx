            ...
            <div className="lg:col-span-7 p-6 sm:p-10 border-b lg:border-b-0 lg:border-r border-neutral-200 dark:border-neutral-800">
              ...
              <div className="flex border border-black dark:border-neutral-700 mb-8 p-1 bg-neutral-100 dark:bg-neutral-900" id="auth-mode-tabs">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 font-mono text-xs font-bold uppercase tracking-wider transition-all cursor-pointer text-neutral-600 dark:text-neutral-400 hover:text-black dark:hover:text-white flex items-center justify-center gap-1.5"
                >
              ...
              {mode === 'signin' && (
                <form onSubmit={handleSignIn} className="space-y-5" id="form-signin">
                  ...
                  {/* Callout to open dedicated Register View */}
                  <div className="mt-8 pt-6 border-t border-neutral-200 dark:border-neutral-800 text-center">
                    <p className="font-mono text-xs text-neutral-600 dark:text-neutral-400 mb-3">
                      Ainda não possui uma conta de produtor no SONIC_LAB?
                    </p>
                    <button
                      id="btn-goto-register-view"
                      type="button"
                      onClick={() => onNavigate('register')}
                      className="w-full py-3 px-4 border border-black dark:border-white/30 bg-neutral-50 dark:bg-neutral-900 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black font-mono text-xs font-bold uppercase tracking-wider transition-colors cursor-pointer flex items-center justify-center gap-2 shadow-sm"
                    >
